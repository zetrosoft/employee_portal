...
def execute_validation(doc, method):
    ...
    items_to_check = [
        ...
        if item.is_finished_item and frappe.db.get_value("Item", item.item_code, "inspection_required_on_manufacture")
    ]
    ...
    frappe.db.set_value("Stock Entry", doc.name, "custom_qc_validation_summary", html_summary, update_modified=False)
